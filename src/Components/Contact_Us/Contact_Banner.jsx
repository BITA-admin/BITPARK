...
import Contact_us from "../../assets/all-images/contactpagebannerimg2.png";
...
const Sample = () => {
  return (
    <>
      ...
      <section className=" bg-[url('src/assets/all-images/email-6370595_1280.jpg')] bg-no-repeat bg-cover">
        <div className=" bg-slate-900/75 pt-[25%] lg:pt-[8%] flex flex-col lg:flex-row items-center justify-around">
          ...
          <img src={Contact_us} alt="Contact_Banner" className="w-[85%] pt-[8%] lg:pt-0 lg:w-[45%]" />
        </div>
      </section>
    </>
  );
